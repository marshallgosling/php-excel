...
class TextData
{
    ...
    public static function SEARCHSENSITIVE($needle, $haystack, $offset = 1)
    {
        ...
        if (!is_bool($needle)) {
            ...
            if (($offset > 0) && (SharedString::CountCharacters($haystack) > $offset)) {
                if (SharedString::CountCharacters($needle) == 0) {
                    return $offset;
                }
    ...
    public static function LOWERCASE($mixedCaseString)
    {
        ...
        return SharedString::StrToLower($mixedCaseString);
    }
    ...
    public static function UPPERCASE($mixedCaseString)
    {
        ...
        return SharedString::StrToUpper($mixedCaseString);
    }
    ...
    public static function PROPERCASE($mixedCaseString)
    {
        ...
        return SharedString::StrToTitle($mixedCaseString);
    }
    ...
    public static function VALUE($value = '')
    {
        ...
        if (!is_numeric($value)) {
            $numberValue = str_replace(
                SharedString::getThousandsSeparator(),
                '',
                trim($value, " \t\n\r\0\x0B" . SharedString::getCurrencyCode())
            );
