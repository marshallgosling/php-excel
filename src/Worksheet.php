...
use Nathan\PHPExcel\Cell\Hyperlink;
use Nathan\PHPExcel\Shared\Font;
use Nathan\PHPExcel\Shared\PasswordHasher;
...
use Nathan\PHPExcel\Worksheet\Protection;
use Nathan\PHPExcel\Worksheet\AutoFilter;
use Nathan\PHPExcel\Worksheet\ColumnDimension;
use Nathan\PHPExcel\Worksheet\ColumnIterator;
use Nathan\PHPExcel\Worksheet\HeaderFooter;
use Nathan\PHPExcel\Worksheet\PageMargins;
use Nathan\PHPExcel\Worksheet\PageSetup;
use Nathan\PHPExcel\Worksheet\RowDimension;
use Nathan\PHPExcel\Worksheet\RowIterator;
...
class Worksheet implements IComparable
{
   ...
   /**
     ...
     * Please note that this will overwrite existing cell styles for cells in range!
     *
     * @param    array of Style_Conditional    $pCellStyle    Cell style to duplicate
     * @param string $pRange Range of cells (i.e. "A1:B10"), or just one cell (i.e. "A1")
     * @throws Exception
     * @return Worksheet
     */
     ...
     * @param  integer $pBreak Break type (type of Worksheet::BREAK_*)
     * @return Worksheet
     */
