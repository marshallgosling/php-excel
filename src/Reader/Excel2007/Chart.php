...
namespace Nathan\PHPExcel\Reader\Excel2007;

use Nathan\PHPExcel\Chart as PHPExcelChart;
use Nathan\PHPExcel\Chart\DataSeries;
use Nathan\PHPExcel\Chart\DataSeriesValues;
...
class Chart
{
    ...
    public static function readChart($chartElements, $chartName)
    {
        ...
        $XaxisLabel = $YaxisLabel = $legend = $title = $plotArea = null;
        ...
        $chart = new PHPExcelChart($chartName, $title, $legend, $plotArea, $plotVisOnly, $dispBlanksAs, $XaxisLabel, $YaxisLabel);
