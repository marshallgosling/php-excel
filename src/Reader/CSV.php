 ...
 */
class CSV extends AbstractReader implements IReader
{
    /**
     * Input encoding
     *
    ...
    public function listWorksheetInfo($pFilename)
    {
        ...
        if (!$this->isValidFormat()) {
            ...
            throw new ReaderException($pFilename . " is an Invalid Spreadsheet file.");
        }
            ...
            foreach ($rowData as $rowDatum) {
                if ($rowDatum != '' && $this->readFilter->readCell($columnLetter, $currentRow)) {
                    ...
                    if ($this->inputEncoding !== 'UTF-8') {
                        $rowDatum = SharedString::ConvertEncoding($rowDatum, 'UTF-8', $this->inputEncoding);
                    }
