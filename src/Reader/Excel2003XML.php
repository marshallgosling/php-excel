 ...
 */
class Excel2003XML extends AbstractReader implements IReader
{
    /**
     * Formats
     *
...
//        echo 'Character Set is ', $this->charSet,'<br />';
    ...
    public function listWorksheetNames($pFilename)
    {
        ...
        $xml = simplexml_load_string($this->securityScan(file_get_contents($pFilename)), 'SimpleXMLElement', Settings::getLibXmlLoaderOptions());
...
//                            echo '<b>Setting row height to '.$rowHeight.'</b><br />';
    ...
    {
        if ($charset != 'UTF-8') {
            return SharedString::ConvertEncoding($string, 'UTF-8', $charset);
        }
        return $string;
    }
