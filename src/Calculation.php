...
use Nathan\PHPExcel\Calculation\CalculationException;
use Nathan\PHPExcel\Calculation\CalculationFunction;
use Nathan\PHPExcel\Calculation\Functions;
use Nathan\PHPExcel\Calculation\Token\Stack;
use Nathan\PHPExcel\Shared\JAMA\Matrix;
...
if (!defined('ROOT')) {
    define('ROOT', __DIR__.PATH_SEPARATOR);
}

/**
 * Calculation (Multiton)
 *
...
class Calculation
{
     ...
     *
     * @access    private
     * @var CalcEngine\CyclicReferenceStack
     *
     */
    ...
    private static $PHPExcelFunctions = array(
        'ABS' => array(
            'category' => CalculationFunction::CATEGORY_MATH_AND_TRIG,
            'functionCall' => 'abs',
            'argumentCount' => '1'
        ),
        'ACCRINT' => array(
            'category' => CalculationFunction::CATEGORY_FINANCIAL,
        ...
        'ADDRESS' => array(
            'category' => CalculationFunction::CATEGORY_LOOKUP_AND_REFERENCE,
        ...
        'AND' => array(
            'category' => CalculationFunction::CATEGORY_LOGICAL,
            'functionCall' => 'Calculation_Logical::LOGICAL_AND',
            'argumentCount' => '1+'
        ),
        'AREAS' => array(
            'category' => CalculationFunction::CATEGORY_LOOKUP_AND_REFERENCE,
            'functionCall' => 'Functions::DUMMY',
            'argumentCount' => '1'
        ),
        'ASC' => array(
            'category' => CalculationFunction::CATEGORY_TEXT_AND_DATA,
            'functionCall' => 'Functions::DUMMY',
            'argumentCount' => '1'
        ),
        'ASIN' => array(
        ...
        'AVEDEV' => array(
            'category' => CalculationFunction::CATEGORY_STATISTICAL,
        ...
        'BESSELI' => array(
            'category' => CalculationFunction::CATEGORY_ENGINEERING,
        ...
        'CELL' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::DUMMY',
            'argumentCount' => '1,2'
        ),
        'CHAR' => array(
        ...
        'CUBEKPIMEMBER' => array(
            'category' => CalculationFunction::CATEGORY_CUBE,
            'functionCall' => 'Functions::DUMMY',
            'argumentCount' => '?'
        ),
        'CUBEMEMBER' => array(
        ...
        'DATE' => array(
            'category' => CalculationFunction::CATEGORY_DATE_AND_TIME,
        ...
        'DAVERAGE' => array(
            'category' => CalculationFunction::CATEGORY_DATABASE,
        ...
        'ERROR.TYPE' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::ERROR_TYPE',
            'argumentCount' => '1'
        ),
        'EVEN' => array(
            'category' => CalculationFunction::CATEGORY_MATH_AND_TRIG,
        ...
        'ISBLANK' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::IS_BLANK',
            'argumentCount' => '1'
        ),
        'ISERR' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::IS_ERR',
            'argumentCount' => '1'
        ),
        'ISERROR' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::IS_ERROR',
            'argumentCount' => '1'
        ),
        'ISEVEN' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::IS_EVEN',
            'argumentCount' => '1'
        ),
        'ISLOGICAL' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::IS_LOGICAL',
            'argumentCount' => '1'
        ),
        'ISNA' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::IS_NA',
            'argumentCount' => '1'
        ),
        'ISNONTEXT' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::IS_NONTEXT',
            'argumentCount' => '1'
        ),
        'ISNUMBER' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::IS_NUMBER',
            'argumentCount' => '1'
        ),
        'ISODD' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::IS_ODD',
            'argumentCount' => '1'
        ),
        'ISPMT' => array(
            'category' => CalculationFunction::CATEGORY_FINANCIAL,
        ...
        'ISTEXT' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::IS_TEXT',
            'argumentCount' => '1'
        ),
        'JIS' => array(
            'category' => CalculationFunction::CATEGORY_TEXT_AND_DATA,
        ...
        'N' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::N',
            'argumentCount' => '1'
        ),
        'NA' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::NA',
            'argumentCount' => '0'
        ),
        'NEGBINOMDIST' => array(
            'category' => CalculationFunction::CATEGORY_STATISTICAL,
        ...
        'SUMIFS' => array(
            'category' => CalculationFunction::CATEGORY_MATH_AND_TRIG,
            'functionCall' => 'Calculation_MathTrig::SUMIFS',
            'argumentCount' => '3+'
        ),
        'SUMPRODUCT' => array(
            'category' => CalculationFunction::CATEGORY_MATH_AND_TRIG,
        ...
        'VALUE' => array(
            'category' => CalculationFunction::CATEGORY_TEXT_AND_DATA,
            'functionCall' => 'Calculation_TextData::VALUE',
            'argumentCount' => '1'
        ),
        'VAR' => array(
            'category' => CalculationFunction::CATEGORY_STATISTICAL,
        ...
        'VERSION' => array(
            'category' => CalculationFunction::CATEGORY_INFORMATION,
            'functionCall' => 'Functions::VERSION',
            'argumentCount' => '0'
        ),
        'VLOOKUP' => array(
            'category' => CalculationFunction::CATEGORY_LOOKUP_AND_REFERENCE,
    ...
    {
        $localeFileDirectory = ROOT.'locale'.PATH_SEPARATOR;
    ...
    public function setLocale($locale = 'en_us')
    {
        ...
        if (in_array($language, self::$validLocaleLanguages)) {
            ...
            if ($locale != 'en_us') {
                ...
                $functionNamesFile = ROOT . 'PHPExcel'.DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.str_replace('_', DIRECTORY_SEPARATOR, $locale).DIRECTORY_SEPARATOR.'functions';
                if (!file_exists($functionNamesFile)) {
                    //    If there isn't a locale specific function file, look for a language specific function file
                    $functionNamesFile = ROOT . 'PHPExcel'.DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.$language.DIRECTORY_SEPARATOR.'functions';
                    if (!file_exists($functionNamesFile)) {
                        return false;
                    }
                }
                ...
                $configFile = ROOT . 'PHPExcel'.DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.str_replace('_', DIRECTORY_SEPARATOR, $locale).DIRECTORY_SEPARATOR.'config';
                if (!file_exists($configFile)) {
                    $configFile = ROOT . 'PHPExcel'.DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.$language.DIRECTORY_SEPARATOR.'config';
                }
                if (file_exists($configFile)) {
    ...
    public function calculateFormula($formula, $cellID = null, Cell $pCell = null)
    {
        ...
        } catch (\Nathan\PHPExcel\Exception $e) {
...
//                    echo '<br />';
                    if ($functionName != 'MKMATRIX') {
                        if ($this->_debugLog->getWriteDebugLog()) {
                            krsort($argArrayVals);
                            $this->_debugLog->writeDebugLog('Evaluating ', self::localeFunc($functionName), '( ', implode(self::$localeArgumentSeparator.' ', Functions::flattenArray($argArrayVals)), ' )');
                        }
                    }
...
//            return array_shift(Functions::flattenArray($output));
//        }
        return $output;
    }
        ...
        if (is_string($operand)) {
            ...
            if (!is_numeric($operand)) {
                ...
                if ($operand > '' && $operand{0} == '#') {
                    ...
                    return false;
                } elseif (!SharedString::convertToNumberIfFraction($operand)) {
    ...
    {
        $inversedStr1 = SharedString::StrCaseReverse($str1);
        $inversedStr2 = SharedString::StrCaseReverse($str2);
...
//            echo '<br />';
    ...
    public function isImplemented($pFunction = '')
    {
        ...
        if (isset(self::$PHPExcelFunctions[$pFunction])) {
            return (self::$PHPExcelFunctions[$pFunction]['functionCall'] != 'Functions::DUMMY');
        } else {
            return false;
        }
    }
     ...
     *
     * @return    array of CalculationFunction
     */
    public function listFunctions()
    {
        ...
        foreach (self::$PHPExcelFunctions as $functionName => $function) {
            if ($function['functionCall'] != 'Functions::DUMMY') {
                $returnValue[$functionName] = new CalculationFunction(
                    $function['category'],
                    $functionName,
