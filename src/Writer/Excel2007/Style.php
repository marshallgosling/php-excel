...
use Nathan\PHPExcel\Style as PHPExcelStyle;
...
class Style extends WriterPart
{
     ...
     * @throws     WriterException
     */
    private function writeFill(XMLWriter $objWriter = null, Fill $pFill = null)
    {
     ...
     * @throws     WriterException
     */
    private function writeGradientFill(XMLWriter $objWriter = null, Fill $pFill = null)
    {
        // fill
     ...
     * @throws     WriterException
     */
    private function writePatternFill(XMLWriter $objWriter = null, Fill $pFill = null)
    {
        // fill
        $objWriter->startElement('fill');
     ...
     * @throws     WriterException
     */
    private function writeFont(XMLWriter $objWriter = null, Font $pFont = null)
    {
        // font
     ...
     * @throws     WriterException
     */
    private function writeBorder(XMLWriter $objWriter = null, Borders $pBorders = null)
    {
        // Write border
     ...
     *
     * @param     XMLWriter            $objWriter         XML Writer
     * @param     PHPExcelStyle                        $pStyle            Style
     * @param     PHPExcel                            $pPHPExcel        Workbook
     * @throws     WriterException
     */
    private function writeCellStyleXf(XMLWriter $objWriter = null, PHPExcelStyle $pStyle = null, PHPExcel $pPHPExcel = null)
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', 0);
     ...
     * @throws     WriterException
     */
    private function writeCellStyleDxf(XMLWriter $objWriter = null, PHPExcelStyle $pStyle = null)
    {
        // dxf
     ...
     * @throws     WriterException
     */
    private function writeBorderPr(XMLWriter $objWriter = null, $pName = 'left', Border $pBorder = null)
    {
        // Write BorderPr
     ...
     * @throws     WriterException
     */
    private function writeNumFmt(XMLWriter $objWriter = null, NumberFormat $pNumberFormat = null, $pId = 0)
    {
     ...
     *
     * @param     PHPExcel                            $pPHPExcel
     * @return     Conditional[]        All conditional styles in PHPExcel
     * @throws     WriterException
     */
     ...
     *
     * @param     PHPExcel                        $pPHPExcel
     * @return     Fill[]        All fills in PHPExcel
     * @throws     WriterException
     */
     ...
     *
     * @param     PHPExcel                        $pPHPExcel
     * @return     Font[]        All fonts in PHPExcel
     * @throws     WriterException
     */
     ...
     *
     * @param     PHPExcel                        $pPHPExcel
     * @return     Borders[]        All borders in PHPExcel
     * @throws     WriterException
     */
     ...
     *
     * @param     PHPExcel                                $pPHPExcel
     * @return     NumberFormat[]        All number formats in PHPExcel
     * @throws     WriterException
     */
