...
class Comments extends WriterPart
{
     ...
     *
     * @param     PHPExcelWorksheet                $pWorksheet
     * @return     string                                 XML Output
     * @throws     WriterException
     */
    public function writeComments(PHPExcelWorksheet $pWorksheet = null)
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @throws     WriterException
     */
    private function writeComment(XMLWriter $objWriter = null, $pCellReference = 'A1', Comment $pComment = null, $pAuthors = null)
    {
        // comment
     ...
     * @throws     WriterException
     */
    public function writeVMLComments(PHPExcelWorksheet $pWorksheet = null)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
     ...
     * @throws     WriterException
     */
    private function writeVMLComment(XMLWriter $objWriter = null, $pCellReference = 'A1', Comment $pComment = null)
    {
         // Metadata
