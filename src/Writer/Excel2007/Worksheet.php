...
class Worksheet extends WriterPart
{
     ...
     * @throws    Exception
     */
    private function writeDimension(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
        // dimension
     ...
     * @throws    Exception
     */
    private function writeSheetViews(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
        // sheetViews
...
//      }
     ...
     * @throws    Exception
     */
    private function writeSheetFormatPr(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
        // sheetFormatPr
        ...
        if ($pSheet->getDefaultRowDimension()->getRowHeight() >= 0) {
            ...
            $objWriter->writeAttribute('defaultRowHeight', SharedString::FormatNumber($pSheet->getDefaultRowDimension()->getRowHeight()));
        } else {
        ...
        if ($pSheet->getDefaultColumnDimension()->getWidth() >= 0) {
            $objWriter->writeAttribute('defaultColWidth', SharedString::FormatNumber($pSheet->getDefaultColumnDimension()->getWidth()));
        }
     ...
     * @throws    Exception
     */
    private function writeCols(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
        // cols
     ...
     * @throws    Exception
     */
    private function writeSheetProtection(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
        // sheetProtection
     ...
     * @throws    Exception
     */
    private function writeConditionalFormatting(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
        // Conditional id
        $id = 1;
     ...
     * @throws    Exception
     */
    private function writeDataValidations(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
     ...
     * @throws    Exception
     */
    private function writeHyperlinks(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
     ...
     * @throws    Exception
     */
    private function writeProtectedRanges(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
     ...
     * @throws    Exception
     */
    private function writeMergeCells(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
     ...
     * @throws    Exception
     */
    private function writePrintOptions(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
        // printOptions
     ...
     * @throws    Exception
     */
    private function writePageMargins(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
        // pageMargins
     ...
     * @throws    Exception
     */
    private function writeAutoFilter(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
        $autoFilterRange = $pSheet->getAutoFilter()->getRange();
        if (!empty($autoFilterRange)) {
            // autoFilter
     ...
     * @throws    Exception
     */
    private function writePageSetup(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
        // pageSetup
     ...
     * @throws    Exception
     */
    private function writeHeaderFooter(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
        // headerFooter
     ...
     * @throws    Exception
     */
    private function writeBreaks(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
        // Get row and column breaks
        $aRowBreaks = array();
        $aColumnBreaks = array();
        foreach ($pSheet->getBreaks() as $cell => $breakType) {
            if ($breakType == PHPExcelWorksheet::BREAK_ROW) {
                $aRowBreaks[] = $cell;
            } elseif ($breakType == PHPExcelWorksheet::BREAK_COLUMN) {
                $aColumnBreaks[] = $cell;
            }
        }
     ...
     * @throws    Exception
     */
    private function writeSheetData(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null, $pStringTable = null)
    {
     ...
     * @throws    Exception
     */
    private function writeCell(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null, $pCellAddress = null, $pStringTable = null, $pFlippedStringTable = null)
    {
...
//                                $calculatedValue = $pCell->getCalculatedValue();
     ...
     * @throws    Exception
     */
    private function writeDrawings(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null, $includeCharts = false)
    {
     ...
     * @throws    Exception
     */
    private function writeLegacyDrawing(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
     ...
     * @throws    Exception
     */
    private function writeLegacyDrawingHF(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
    {
