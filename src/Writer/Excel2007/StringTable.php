...
class StringTable extends WriterPart
{
        ...
        if ($pStringTable !== null) {
            ...
            foreach ($pStringTable as $textElement) {
                ...
                if (! $textElement instanceof RichText) {
                    $textToWrite = SharedString::ControlCharacterPHP2OOXML($textElement);
            ...
            throw new WriterException("Invalid string table array passed.");
        }
    }
     ...
     * @throws     Writer_Exception
     */
    public function writeRichText(XMLWriter $objWriter = null, RichText $pRichText = null, $prefix = null)
    {
        if ($prefix !== null) {
            $prefix .= ':';
        }
        ...
        foreach ($elements as $element) {
            ...
            $objWriter->writeAttribute('xml:space', 'preserve');
            $objWriter->writeRawData(SharedString::ControlCharacterPHP2OOXML($element->getText()));
            $objWriter->endElement();
     ...
     * @throws     Writer_Exception
     */
    public function writeRichTextForCharts(XMLWriter $objWriter = null, $pRichText = null, $prefix = null)
    {
