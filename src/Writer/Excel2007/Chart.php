...
use Nathan\PHPExcel\Chart as PHPExcelChart;
use Nathan\PHPExcel\Chart\Legend;
use Nathan\PHPExcel\Chart\Title;
use Nathan\PHPExcel\Chart\Axis;
use Nathan\PHPExcel\Chart\PlotArea;
use Nathan\PHPExcel\Chart\DataSeries;
use Nathan\PHPExcel\Chart\GridLines;
use Nathan\PHPExcel\Chart\Layout;
...
class Chart extends WriterPart
{
     ...
     *
     * @param  PHPExcelChart $pChart
     *
     * @return  string            XML Output
     * @throws  WriterException
     */
    public function writeChart(PHPExcelChart $pChart = null, $calculateCellValues = true)
    {
     ...
     * @throws  WriterException
     */
    private function writePlotArea(PlotArea $plotArea, Title $xAxisLabel = null, Title $yAxisLabel = null, $objWriter, Worksheet $pSheet, Axis $xAxis, Axis $yAxis, GridLines $majorGridlines, GridLines $minorGridlines)
    {
        if (is_null($plotArea)) {
            return;
        }
    ...
    private function writeCategoryAxis($objWriter, PlotArea $plotArea, $xAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis)
    {
        ...
        if (!is_null($xAxisLabel)) {
            ...
            $objWriter->writeRawData(String::ControlCharacterPHP2OOXML($caption));
            $objWriter->endElement();
     ...
     * @throws  WriterException
     */
    private function writePlotSeriesValues($plotSeriesValues, $objWriter, $groupType, $dataType = 'str', Worksheet $pSheet)
    {
     ...
     * @throws  Writer_Exception
     */
    private function writeBubbles($plotSeriesValues, $objWriter, Worksheet $pSheet)
    {
        if (is_null($plotSeriesValues)) {
            return;
        }
