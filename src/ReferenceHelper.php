...
class ReferenceHelper
{
    ...
    protected function adjustPageBreaks(Worksheet $pSheet, $pBefore, $beforeColumnIndex, $pNumCols, $beforeRow, $pNumRows)
    {
        ...
        ($pNumCols > 0 || $pNumRows > 0) ?
            uksort($aBreaks, array('ReferenceHelper','cellReverseSort')) :
            uksort($aBreaks, array('ReferenceHelper','cellSort'));
    ...
    protected function adjustHyperlinks($pSheet, $pBefore, $beforeColumnIndex, $pNumCols, $beforeRow, $pNumRows)
    {
        ...
        ($pNumCols > 0 || $pNumRows > 0) ? uksort($aHyperlinkCollection, array('ReferenceHelper','cellReverseSort')) : uksort($aHyperlinkCollection, array('ReferenceHelper','cellSort'));
    ...
    protected function adjustDataValidations($pSheet, $pBefore, $beforeColumnIndex, $pNumCols, $beforeRow, $pNumRows)
    {
        ...
        ($pNumCols > 0 || $pNumRows > 0) ? uksort($aDataValidationCollection, array('ReferenceHelper','cellReverseSort')) : uksort($aDataValidationCollection, array('ReferenceHelper','cellSort'));
    ...
    protected function adjustProtectedCells($pSheet, $pBefore, $beforeColumnIndex, $pNumCols, $beforeRow, $pNumRows)
    {
        ...
        ($pNumCols > 0 || $pNumRows > 0) ?
            uksort($aProtectedCells, array('ReferenceHelper','cellReverseSort')) :
            uksort($aProtectedCells, array('ReferenceHelper','cellSort'));
