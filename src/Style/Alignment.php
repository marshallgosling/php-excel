...
class Alignment extends Supervisor implements IComparable
{
     ...
     * @var string
     */
    protected $horizontal = Alignment::HORIZONTAL_GENERAL;
     ...
     * @var string
     */
    protected $vertical = Alignment::VERTICAL_BOTTOM;
     ...
     * @return Alignment
     */
    public function setHorizontal($pValue = Alignment::HORIZONTAL_GENERAL)
    {
        if ($pValue == '') {
            $pValue = Alignment::HORIZONTAL_GENERAL;
        }
     ...
     * @return Alignment
     */
    public function setVertical($pValue = Alignment::VERTICAL_BOTTOM)
    {
        if ($pValue == '') {
            $pValue = Alignment::VERTICAL_BOTTOM;
        }
