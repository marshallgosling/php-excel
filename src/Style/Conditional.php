...
class Conditional implements IComparable
{
    ...
    {
        // Initialise values
        $this->conditionType = Conditional::CONDITION_NONE;
        $this->operatorType  = Conditional::OPERATOR_NONE;
        $this->text          = null;
     ...
     * Set Condition type
     *
     * @param string $pValue    Conditional condition type
     * @return Conditional
     */
    public function setConditionType($pValue = Conditional::CONDITION_NONE)
    {
     ...
     * @return Conditional
     */
    public function setOperatorType($pValue = Conditional::OPERATOR_NONE)
    {
