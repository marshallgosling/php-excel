...
class Color extends Supervisor implements IComparable
{
     ...
     *                                        its ramifications are
     */
    public function __construct($pARGB = Color::COLOR_BLACK, $isSupervisor = false, $isConditional = false)
    {
        //    Supervisor?
     ...
     * @return Color
     */
    public function setARGB($pValue = Color::COLOR_BLACK)
    {
        if ($pValue == '') {
            $pValue = Color::COLOR_BLACK;
        }
        if ($this->isSupervisor) {
