...
namespace Nathan\PHPExcel\Shared\OLE\PPS;

use Nathan\PHPExcel\Shared\File;
use Nathan\PHPExcel\Shared\OLE;
use Nathan\PHPExcel\Shared\OLE\PPS;
...
class Root extends PPS
{
    ...
    {
        $this->_tempDir = File::sys_get_temp_dir();

        parent::__construct(null, OLE::Asc2Ucs('Root Entry'), OLE::OLE_PPS_TYPE_ROOT, null, null, null, $time_1st, $time_2nd, null, $raChild);
    }
    ...
    public function save($filename)
    {
        ...
        if (is_resource($filename)) {
            ...
            if ($this->tempDirectory === null) {
                $this->tempDirectory = File::sys_get_temp_dir();
            }
        ...
        $aList = array();
        PPS::_savePpsSetPnt($aList, array($this));
    ...
    */
    ...
    /**
    * Saving big data (PPS's with data bigger than OLE::OLE_DATA_SIZE_SMALL)
    *
    * @access public
    ...
    */
    ...
    /**
    * get small data (PPS's with data smaller than OLE::OLE_DATA_SIZE_SMALL)
    *
    * @access public
    * @param array &$raList Reference to array of PPS's
    */
