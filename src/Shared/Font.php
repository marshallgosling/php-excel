...
namespace Nathan\PHPExcel\Shared;
...
class Font
{
     ...
     *
     * @param     StyleFont            $font            Font object
     * @param     RichText|string    $cellText        Text to calculate width
     * @param     integer                        $rotation        Rotation angle
     * @param     StyleFont|NULL    $defaultFont    Font object
     * @return     integer        Column width
     */
    public static function calculateColumnWidth(StyleFont $font, $cellText = '', $rotation = 0, StyleFont $defaultFont = null)
    {
     ...
     * @throws Exception
     */
    public static function getTextWidthPixelsExact($text, StyleFont $font, $rotation = 0)
    {
...
//        $upperLeftCornerY  = $textBox[7];
     ...
     */
    public static function getTextWidthPixelsApprox($columnText, StyleFont $font = null, $rotation = 0)
    {
        ...
        switch ($fontName) {
            case 'Calibri':
                ...
                $columnWidth = (int) (8.26 * SharedString::CountCharacters($columnText));
                $columnWidth = $columnWidth * $fontSize / 11; // extrapolate from font size
                break;

            case 'Arial':
                // value 7 was found via interpolation by inspecting real Excel files with Arial 10 font.
//                $columnWidth = (int) (7 * SharedString::CountCharacters($columnText));
                // value 8 was set because of experience in different exports at Arial 10 font.
                $columnWidth = (int) (8 * SharedString::CountCharacters($columnText));
     ...
     *
     * @param StyleFont $font The workbooks default font
     * @param boolean $pPixels true = return column width in pixels, false = return in OOXML units
     * @return mixed Column width
     */
    public static function getDefaultColumnWidthByFont(StyleFont $font, $pPixels = false)
    {
     ...
     */
    public static function getDefaultRowHeightByFont(StyleFont $font)
    {
        switch ($font->getName()) {
            case 'Arial':
                switch ($font->getSize()) {
