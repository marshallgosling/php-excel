...
class OLERead
{
    ...
    public function read($sFileName)
    {
        ...
        if (!is_readable($sFileName)) {
            throw new ReaderException("Could not open " . $sFileName . " for reading! File does not exist, or it is not readable.");
        }
        ...
        if ($this->data != self::IDENTIFIER_OLE) {
            throw new ReaderException('The filename ' . $sFileName . ' is not recognised as an OLE file');
        }
