...
class Drawing
{
     ...
     *
     * @param     int $pValue    Value in pixels
     * @param     StyleFont $pDefaultFont    Default font of the workbook
     * @return     int            Value in cell dimension
     */
    public static function pixelsToCellDimension($pValue = 0, StyleFont $pDefaultFont)
    {
        // Font name and size
     ...
     * @return     int        Value in pixels
     */
    public static function cellDimensionToPixels($pValue = 0, StyleFont $pDefaultFont)
    {
        // Font name and size
        $name = $pDefaultFont->getName();
        $size = $pDefaultFont->getSize();
