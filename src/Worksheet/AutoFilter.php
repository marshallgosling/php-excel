...
class AutoFilter
{
     ...
     *
     * @var array of AutoFilter_Column
     */
     ...
     *
     * @throws    Exception
     * @return array of AutoFilter_Column
     */
     ...
     *    Set AutoFilter
     *
     *    @param    AutoFilter_Column|string        $pColumn
    ...
    private static function filterTestInDateGroupSet($cellValue, $dataSet)
    {
        ...
        if (is_numeric($cellValue)) {
            $dateValue = Date::ExcelToPHP($cellValue);
            if ($cellValue < 1) {
                //    Just the time part
    ...
    private static function filterTestInPeriodDateSet($cellValue, $monthSet)
    {
        ...
        if (is_numeric($cellValue)) {
            $dateValue = date('m', Date::ExcelToPHP($cellValue));
     ...
     *    @param    AutoFilter_Column        &$filterColumn
     *    @return mixed[]
     */
