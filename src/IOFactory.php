...
class IOFactory
{
    ...
    private static $searchLocations = array(
        array( 'type' => 'IWriter', 'path' => 'PHPExcel/Writer/{0}.php', 'class' => '\\Nathan\\PHPExcel\\Writer\\{0}' ),
        array( 'type' => 'IReader', 'path' => 'PHPExcel/Reader/{0}.php', 'class' => '\\Nathan\\PHPExcel\\Reader\\{0}' )
    );
